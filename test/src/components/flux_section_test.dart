...
void main() {
  ...
  group('FluxSection — default constructor', () {
    ...
    testWidgets('applies padding', (tester) async {
      await tester.pumpWidget(
        wrap(const FluxSection(title: Text('padded'), padding: EdgeInsets.all(24))),
      );
  ...
  group('FluxSection.header', () {
    ...
    testWidgets('implements FluxSlotWrapper — externalPaddingOverride matches margin', (
      tester,
    ) async {
      const section = FluxSection.header(title: Text('bleed'), margin: EdgeInsets.zero);
  ...
  group('FluxSection.footer', () {
    ...
    testWidgets('implements FluxSlotWrapper — externalPaddingOverride matches margin', (
      ...
      const section = FluxSection.footer(margin: EdgeInsets.symmetric(horizontal: 16));
  ...
  group('FluxSection — full bleed via margin', () {
    testWidgets('margin: EdgeInsets.zero causes externalPaddingOverride to be zero', (
      tester,
    ) async {
      await tester.pumpWidget(
        wrap(
