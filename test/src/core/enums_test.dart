...
void main() {
  ...
  group('FluxMediaPosition', () {
    test('contains start and end', () {
      ...
      expect(
        FluxMediaPosition.values,
        containsAll([FluxMediaPosition.start, FluxMediaPosition.end]),
      );
    });
  });
  ...
  group('FluxNotchEdge', () {
    test('contains vertical and horizontal', () {
      ...
      expect(FluxNotchEdge.values, containsAll([FluxNotchEdge.vertical, FluxNotchEdge.horizontal]));
    });
  });
  ...
  group('FluxNotchSide', () {
    test('contains start, end, and both', () {
      ...
      expect(
        FluxNotchSide.values,
        containsAll([FluxNotchSide.start, FluxNotchSide.end, FluxNotchSide.both]),
      );
    });
  });
